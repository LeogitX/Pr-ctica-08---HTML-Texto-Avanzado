...
describe('Ejercicio 13: Navegación entre páginas e imágenes', () => {
  ...
  const ejercicio13Path = path.join(srcPath, 'ejercicio-13');
  ...
  test('La carpeta src/ejercicio-13 debe existir', () => {
  ...
  test('La carpeta src/ejercicio-13/imagenes debe existir', () => {
  ...
  test('El archivo src/ejercicio-13/index.html debe existir', () => {
