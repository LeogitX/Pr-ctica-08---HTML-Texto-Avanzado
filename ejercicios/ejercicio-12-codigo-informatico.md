...
### Forma directa
- Abre `src/ejercicio-11/materia.html` directamente en tu navegador
...
### Parte 1: Usar estructura de carpetas
1. Utilizar la subcarpeta `src/ejercicio-11` del ejercicio anterior.
